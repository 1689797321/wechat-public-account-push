export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf363781007dacb60",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "97adbf7e1f790e7200d39d57eaa8683f",
  ...
  USERS: [
    {
      ...
      id: "o8yts5jmQZOFt-N-8D-Stw4z99Fw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "gKyoYrIYuA8-vy-ME3XlDTdcyarsaA1jgj-hLnJBBsE",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
